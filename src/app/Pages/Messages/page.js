...
function IconLeftbar({ onCreatePost, onShowSearch, onShowNotifications }) {
  return (
    <aside className="w-16 h-screen fixed bg-white border-r border-gray-300 p-2 flex flex-col items-center space-y-6 z-10">
      ...
      <Link href="/">
        <button className="p-3 hover:bg-gray-200 rounded-md" title="Home">
          <svg className="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            <path d="M3 9.5L12 4l9 5.5V20a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1V9.5Z" />
          </svg>
        </button>
      </Link>
      <button className="p-3 hover:bg-gray-200 rounded-md" onClick={onShowSearch} title="Search">
        <svg className="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <Link href="/Pages/Explore">
        <button className="p-3 hover:bg-gray-200 rounded-md" title="Explore">
          <svg className="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <Link href="/Pages/Reels">
        <button className="p-3 hover:bg-gray-200 rounded-md" title="Reels">
          <svg className="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <Link href="/messages">
        <button className="p-3 hover:bg-gray-200 rounded-md" title="Messages">
          <svg className="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <Link href="/Pages/Profile">
        <button className="p-3 hover:bg-gray-200 rounded-md" title="Profile">
          <svg className="w-6 h-6 text-gray-700" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
...
export default function Page() {
  ...
  return (
    <div className="flex h-screen">
      ...
      />
      <div className="ml-16 flex flex-1 relative">
        {showUserList && (
          <UserList
            users={followedUsers}
        ...
        {showChat && selectedUser && (
          <div className={`flex-1 flex flex-col h-full ${isMobile ? "absolute inset-0 bg-white z-20" : ""}`}>
            <ChatWindow
              user={user}
              messages={messages}
